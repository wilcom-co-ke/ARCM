                                        ...
                                        <div class="tab-content " id="nav-tabContent">
                                            ...
                                            >
                                                <div>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <a
                                                                                    style={{ color: "#f44542" }}
                                                                                    onClick={e =>
                                                                                        this.handleDeleteDocument(r,"Documents", e)
                                                                                    }
                                                                                >
                                                                                    &nbsp; Remove
                                                                                </a>
                                                 ...
                                                 <br/>
                                                    {this.validaterole("Hearing In Progress", "AddNew") ? (
                                                        <button onClick={this.handleDocumentsUploadClick} style={{ float: "right" }} className="btn btn-success">Upload</button>
                                                    ) : (
                                                            <i></i>
                                                        )}
                                            ...
                                            >
                                                <div>
                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <a
                                                                                    style={{ color: "#f44542" }}
                                                                                    onClick={e =>
                                                                                        this.handleDeleteDocument(r,"Audios", e)
                                                                                    }
                                                                                >
                                                                                    &nbsp; Remove
                                                                                </a>
                                                    ...
                                                    <br />
                                                    {this.validaterole("Hearing In Progress", "AddNew") ? (
                                                        <button onClick={this.handleAudioUploadClick} style={{ float: "right" }} className="btn btn-success">Upload</button>
                                                    ) : (
                                                            <i></i>
                                                        )}
                                            ...
                                            >
                                                <div>
                                                                        ...
                                                                        <span>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <a
                                                                                    style={{ color: "#f44542" }}
                                                                                    onClick={e =>
                                                                                        this.handleDeleteDocument(r,"Vedios", e)
                                                                                    }
                                                                                >
                                                                                    &nbsp; Remove
                                                                                </a>
                                                    ...
                                                    <br />
                                                    {this.validaterole("Hearing In Progress", "AddNew") ? (
                                                        <button onClick={this.handleVedioUploadClick} style={{ float: "right" }} className="btn btn-success">Upload</button>
                                                    ) : (
                                                            <i></i>
                                                        )}
...
export default HearingInprogress;
