...
class DecisionPreparations extends Component {
   ...
   OpenFindingsModal = () => {
    ...
    openIssuesModal=()=>{
        this.setState({ openIssuesModal:true})
    }
    ...
    HandleIssuesEdit=(d)=>
    {
        this.setState({ Description: d.Description,openIssuesModal: true,Number:d.NO,IsUpdateissues:true });
    }
    HandleFindingsEdit=d=>{
        this.setState({  Action:d. Actions,Description: d.Description, openFindingsModal: true, Number: d.NO, IsUpdateFindings:true });
    }
    ProtectRoute() {
                ...
                .then(response =>
                    response.json().then(data => {
                        if (data.success) {
                            ...
                            this.setState({ Description: "", openFindingsModal: false, Number: "", IsUpdateFindings: false });
                ...
                .then(response =>
                    response.json().then(data => {
                        if (data.success) {
                            ...
                            this.setState({ Findings: rows, Description: "", Number: "", IsUpdateFindings: false });
            ...
            fetch("/api/issuesfordetermination/" + this.state.Number, {
                ...
                .then(response =>
                    response.json().then(data => {
                        if (data.success) {
                            swal("", "Added Successfully", "success");
                            this.setState({ Description: "", openIssuesModal: false, Number: "", IsUpdateissues: false });
                            this.fetchIssues(this.state.Description)
                        } else {
                            swal("", data.message, "error");
                        }
                    })
            ...
            .then(response =>
                response.json().then(data => {
                    if (data.success) {
                        ...
                        rows.push(datatoPush);
                        this.setState({ Issues: rows,Description: "", openIssuesModal: false, Number: "", IsUpdateissues: false });
                        ...
                        <div className="row">                            
                            ...
                            <div className="col-lg-10 ">
                                ...
                                <div className="row border border-success rounded bg-white">
                                    <div class="col-sm-12">
                                        <Modal visible={this.state.openIssuesModal} width="90%" height="550px" effect="fadeInUp" onClickAway={() => this.closePlyer()}>
                                            <div>

                                                <a style={{ float: "right", color: "red", margin: "10px" }} href="javascript:void(0);" onClick={() => this.closePlyer()}>Close</a>
                                                <h4 style={{ "text-align": "center", color: "#1c84c6" }}> Issues for Determinations</h4>
                                                ...
                                                <div classname="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <CKEditor
                                                                          data={this.state.Description}  onChange={this.onIssuesEditorChange}
                                                        />
                                                    </div>
                                                </div>
                                                <br/>
                                        ...
                                        <br/>
                                        <button className="btn btn-primary" onClick={this.openIssuesModal}>Add </button>
                                        <p></p>
                                       <div>
                          ...
                          <div className="row">                            
                            ...
                            <div className="col-lg-10 ">
                                ...
                                <div className="row border border-success rounded bg-white">
                                    <div class="col-sm-12">
                                        <Modal visible={this.state.openFindingsModal} width="90%" height="550px" effect="fadeInUp" onClickAway={() => this.closeFindingsModal()}>
                                            <div>
                                                <a style={{ float: "right", color: "red", margin: "10px" }} href="javascript:void(0);" onClick={() => this.closeFindingsModal()}>Close</a>
                                                <h4 style={{ "text-align": "center", color: "#1c84c6" }}> Findings on Issues for Determinations</h4>
                                                                    ...
                                                                    Number
                                                                            ...
                                                                            <Select
                                                                                ...
                                                                                value={IssuesOptions.filter(
                                                                                    option =>
                                                                                        option.label === this.state.Number
                                                                                )}                                                                            
                                                                        ...
                                                                        <div className="col-sm-6">
                                                                            ...
                                                                            value={ActionsOptions.filter(
                                                                                option =>
                                                                                    option.label === this.state.Action
                                                                                )}
                                                                                onChange={this.handleSelectChange}
                                        ...
                                        <br/>
                                        <button className="btn btn-primary" onClick={this.OpenFindingsModal}>Add </button>
                                        <p></p>
                                       <div>
                                        <table class="table table-sm">
                                                <thead className="thead-light">
                            ...
                            <div className="col-lg-10 ">
                                ...
                                <div className="row border border-success rounded bg-white">
                                    <div class="col-sm-12">
                                        ...
                                        <Modal visible={this.state.open} width="700" height="350" effect="fadeInUp" onClickAway={() => this.closeModal()}>
                                            <div>
