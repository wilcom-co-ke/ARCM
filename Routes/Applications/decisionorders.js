...
decisionorders.get("/:ID", auth.validateRole("Decision"), function (
    req,
    res
) {
...
decisionorders.post("/", auth.validateRole("Decision"), function (
    req,
    res
) {
...
decisionorders.put("/:ID", auth.validateRole("Decision"), function (
    req,
    res
) {
    const schema = Joi.object().keys({
