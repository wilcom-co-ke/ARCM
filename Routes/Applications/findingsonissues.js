...
findingsonissues.get("/:ID", auth.validateRole("Decision"), function(
  req,
  res
) {
...
findingsonissues.post("/", auth.validateRole("Decision"), function(
  req,
  res
) {
...
findingsonissues.put("/:ID", auth.validateRole("Decision"), function(
  req,
  res
) {
  const schema = Joi.object().keys({
